...
$startdate = date_create("2022-8-29");/////////////////第一周开始时间，每学期都要改//////////////////////


function del_object($arr, $week)
{////获取到的都是周课表，需要删除非当天的数据
...
function get_week_num($date = null)
{//取当前周次 $date=null 表示参数可缺省
    global $startdate;
    if ($date !== null) {
...
function getTabledate($openid, $info)
{//table格式化为二维数组
